 ...
 */
public class McClamma_as1_EmptyPQException extends RuntimeException {
     ...
     * Empty constructor
     */
    public McClamma_as1_EmptyPQException() {
    }
     ...
     *            the error message
     */
    public McClamma_as1_EmptyPQException(String message) {
        super(message);
    }
}