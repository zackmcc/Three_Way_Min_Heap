...
public class McClamma_as1_MinHeap<Key extends Comparable<Key>, Value> implements McClamma_as1_PriorityQueue<Key, Value>{
	 ...
	 * Outputs - none */
	McClamma_as1_MinHeap(int newSize){
		N = 0;
	...
	private void resize(int newSize) {
		...
		if (newSize <= 0)
		{
			throw new McClamma_as1_EmptyPQException("Cannot create Priority Queue of size less than or equal to 0");
		}
	...
	public Key findMin() {
		...
		if(N ==0)
				throw new McClamma_as1_EmptyPQException("Empty Priority Queue");
		else
			return keys[1];
	}
